...
<body >
  ...
  <div class="collapse navbar-collapse menubar " id="navbarNav">
    <ul class="navbar-nav ml-auto text-white">
      ...
      <li class="nav-item">
        <a class="nav-link" href="package_home.php">Package</a>
      </li>
      <li class="nav-item">
        <a class="nav-link " href="#t">Blog</a>
      </li>
      <li class="nav-item">
		...
		<div class="container">
			<div class="row" id="about">
				<div class="col-md-6 mt">
					<p class="text-black"><b class="mt-30">MUNNAR</b> Munnar is a quaint town and an idyllic hill station located in the Western Ghats of Kerala. Set at an altitude of 6000 ft in the district of Idukki, Munnar used to be the summer resort of the British rulers during colonial times. It is known for its green belt of lush forests and unending expanse of tea estates and is also home to some of the endangered species of animals like Neelakurinji and Nilgiri Tahr. It is known to be one of the most sought after tourist destinations in South India due to its pristine valleys, mountains, and exotic varieties of flora and fauna. 
...
The weather in Munnar remains quite pleasant throughout the year, but in summer, people especially come to this place to escape from the scorching heat in other parts of the country. During monsoon season Munnar experiences heavy rainfall that might hamper your travel plan as most of the activities are restricted during this time of the year. The best time to visit Munnar is between March to September when the weather stays very pleasant.  </p>
				 ...
				 <div class="col-md-6 text-center">
				 	<img src="mm.jpg"  class="img-fluid imgsize" height="100%" width="100%">
          <img src="mh.webp"  class="img-fluid imgsize" height="100%" width="100%">
...
<section class="bg-white">
  <div class="container ">
    ...
    <div class="row">
      ...
      <div class="col-3 ">
        <img src="M4.jpg "class="img-fluid">
      </div>
      <div class="col-3 ">
        <img src="M5.jpg" class="img-fluid">
      </div>
      <div class="col-3 ">
        <img src="munnar.jpg "class="img-fluid">
      </div>
     </div>
    </div>
</section>
<section class="bg-white">
  <div class="container ">
    ...
    <div class="row">
      ...
      <div class="col-3 ">
        <img src="M1.webp"class="img-fluid">
      </div>
      <div class="col-3 ">
        <img src="M3.webp "class="img-fluid">
      </div>
      <div class="col-3 ">
        <img src="mt.jpg" class="img-fluid">
      </div>
      <div class="col-3 ">
        <img src=" M2.jpg"class="img-fluid">
      </div>
    ...
    <div class="col-lg-5 mb-lg-0 mb-4">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="md-form">
            <i class="fas fa-tag prefix grey-text"></i>
            <label for="form-Subject">contact number</label>
      ...
      <div id="map-container-section" class="z-depth-1-half map-container-section mb-4" style="height: 400px">
        <iframe src="https://maps.google.com/maps?q=Manhatan&t=&z=15&ie=UTF8&iwloc=&output=embed" frameborder="0"
          ...
          <div class="text-dark">
					...
					<p>D3, 3th Floor, Sumaj Complex,</p>
					 <p>Sreekariyam</p>
					<p>Trivandrum - 695581</p>
					<p>Kerala, India</p>
					<p>+91 9207069824</p>
					<p>alsconquerors@gmail.com</p>
...
<!-- Section: Contact v.1 -->
  ...
  <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
    © 2021 Copyright:
    <a class="text-dark" href="#">Travelmate</a>
  </div>
  <!-- Copyright -->
</footer>
